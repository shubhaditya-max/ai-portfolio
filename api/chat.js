module.exports = async function handler(req, res) {
    ...
    try {
        ...
        - Professional Work (AdmitKard/Uniply.ai): I owned Uniply Copilot (RAG search) from 0-1. I reduced AWS spend by 75%, scaled capacity 5x, and cut manual effort by 50%.
        ...
        const response = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=${apiKey}`, {
            ...
            body: JSON.stringify({
                system_instruction: { 
                    parts: [{ text: systemPrompt }] // <-- BUG FIXED HERE
                },
